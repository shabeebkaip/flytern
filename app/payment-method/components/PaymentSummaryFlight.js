    ...
    <div className='flex flex-col items-start justify-start gap-10 p-4 bg-white rounded-lg'>
      ...
      <div className='grid w-full grid-cols-1 gap-4' >
        ...
        <div className={` border-t py-3`}>
          <LabelValue label={translation?.total_amount} value={`${parseFloat(selectedPrice.finalAmount).toFixed(3)} ${selectedPrice.currencyCode}`} pStyles={"font-semibold text-base"} />
        </div>
      </div>
