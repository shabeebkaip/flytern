      ...
      <div className='flex flex-col items-center justify-center h-full bg-white lg:items-start'>
        <div className='container flex flex-col gap-6 px-10 mx-auto md:px-32' >
          <div className='flex gap-3 item-center'>
            ...
            <h4 className ="text-black text-lg sm:text-2xl font-bold">{translation?.reset_password}</h4>
          </div>
          <p className="w-full lg:w-[350px] text-stone-500 text-xs sm:text-sm font-normal leading-[200%]">{translation?.reset_content}</p>
          <div className="grid grid-cols-10 mt-8">
            <div className='flex flex-col col-span-10 gap-2 sm:col-span-6'>
              ...
              <div onClick={changePassword}><button className="w-full  h-12 mt-3 text-base font-medium text-white rounded-md bg-emerald-800 " >{translation?.reset_password}</button></div>
