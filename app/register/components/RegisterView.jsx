  ...
  return (
    <div className='flex flex-col items-center h-full py-20 bg-white lg:items-start lg:py-0 lg:justify-center'>
      <div className='container flex flex-col gap-6 px-10 mx-auto md:px-32'>
        ...
        <p className="text-stone-500 text-sm font-normal leading-[200%] max-w-[350px] 2xl:max-w-[450px]">{translation?.join_as}</p>
        ...
        <div className="relative text-sm font-normal text-gray-500">{translation?.upload_photo}</div>
        ...
        <div className="relative w-full lg:max-w-[350px] 2xl:max-w-[450px]">
          ...
          />
          <RemoveRedEyeIcon
            className='absolute z-40 top-[12px] right-4 text-slate-500 cursor-pointer'
        ...
        <button className='h-12 mt-3 text-base font-medium text-white rounded-md bg-emerald-800 w-full lg:max-w-[350px] 2xl:max-w-[450px]' onClick={onSave}>
          {loader ? <CircularProgress style={{ color: 'white' }} /> : translation?.create_an_account}
        </button>
        <div className="text-center flex justify-center w-full lg:max-w-[450px] gap-1">
          ...
          <div
            ...
            className="text-xs font-semibold text-orange-400 cursor-pointer sm:text-sm"
          >
            {translation?.sign_in}
          </div>
        </div>
        <div className="h-[19px] items-center gap-1.5 lg:inline-flex flex justify-center w-full lg:max-w-[450px]">
        ...
        <div className="text-center flex gap-2 justify-center items-center w-full lg:max-w-[450px]">
          <span className="text-xs font-normal text-black sm:text-sm">{translation?.continue_as_a} </span>
          <div
            onClick={() => { if (typeof window !== "undefined") { window.location.href = "/" } }}
            className="text-xs font-medium text-orange-400 cursor-pointer sm:text-sm"
          >
            {translation?.guest_user}
          </div>
        </div>
      </div>
    </div>
