    ...
    <div className="gap-5 duration-300 ease-in-out flexflex-col mt-7">
              ...
              >
                {
                  ...
                  <div className="flex items-center gap-2 flex-start" onClick={() => lastElement.departure && lastElement.arrival && lastElement.departureDate ? handleAddCity() : null}>
                    ...
                    <p className={`text-center ${lastElement.departure && lastElement.arrival && lastElement.departureDate ? 'text-orange-400' : 'text-font-gray'} text-xs md:text-sm font-medium  capitalize`}>
                      {selectedLanguageAndCountry?.language?.code === "ar"
...

                {
                  flightSearch?.searchList.length > 1 && (
                    <div onClick={() => handleRemove()}>
                      <p className={`text-center text-red-500 text-[8px] md:text-sm font-medium  capitalize`}>
                        Remove City
                      </p>
                    </div>)
                }
      ...
      <div className="grid grid-cols-2 gap-5 mt-[1.5rem]">
        <div className="flex items-center justify-start gap-3">
          ...
          />
          <label className="text-center text-zinc-900 text-xs md:text-sm font-normal ">
            {selectedLanguageAndCountry?.language?.code === "ar"
