  ...
  return (
    <div>
      <div class="px-2.5 py-1 bg-white rounded-[5px] border border-zinc-100 justify-start items-center gap-2.5 inline-flex relative cursor-pointer w-full">
        <div class="grow shrink basis-0 flex justify-between items-start gap-[7px] ">
          <div class="justify-start items-center gap-2.5 inline-flex w-full">
            ...
            <div class="flex-col justify-start items-start gap-1.5 inline-flex w-full" >
              <div class="text-gray-500 text-[8px] md:text-xs xl:text-sm  font-normal w-full">
